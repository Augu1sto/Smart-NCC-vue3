...
@font-face {
    ...
    src: url("@/static/fonts/subset-ZoomlaTouyingheiA032.woff2") format("woff2"),
        url("@/static/fonts/subset-ZoomlaTouyingheiA032.woff") format("woff");
    font-weight: normal;
    font-style: normal;
    font-display: swap; // 未渲染前用系统字体
}
